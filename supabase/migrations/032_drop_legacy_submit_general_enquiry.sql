-- Remove the 7-parameter submit_general_enquiry overload from 019.
-- Migration 029/030 added a 9-parameter version; CREATE OR REPLACE does not
-- drop a different signature, so both overloads existed and RPC calls failed with:
...
-- Ensure the current 9-parameter function exists (030 is authoritative).
