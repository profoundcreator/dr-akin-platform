...
const SPHERES = [
  {
    ...
    subtitle: "Biography",
    href: "/meet-akin/profile",
    description:
      "Decades of experience in executive coaching, organisational consulting, and leadership development across Africa and the global diaspora.",
  },
  {
    number: "02",
    title: "Continental Mandate",
    subtitle: "AU Agenda 2063",
    href: "/meet-akin/au-ambassador",
    description:
      "A voice for Africa's transformation agenda, connecting continental aspirations with practical leadership development.",
  },
  {
    number: "03",
    title: "Board Governance",
    subtitle: "Advisory & boards",
    href: "/meet-akin/edu-governance",
    description:
      "Advising boards and governance bodies on leadership transitions, fiduciary responsibility, and long-term institutional stewardship.",
  },
  {
    number: "04",
    title: "Keynote Speaking",
    subtitle: "Stages & engagements",
    href: "/meet-akin/speaking",
    description:
      "Keynotes, panels, workshops, and fireside conversations for conferences, corporate retreats, and leadership summits worldwide.",
  },
];

interface MeetHubPageProps {
  content: PageContent;
}

export function MeetHubPage({ content }: MeetHubPageProps) {
  return (
    <PageShell>
        ...
        <div className="mx-auto max-w-[var(--ploy-canvas-main)]">
          <Reveal className="mb-14 max-w-3xl space-y-4">
            ...
            <Heading as="h2" size="section" tone="inverse" className="ploy-text-balance">
              Leadership across business, education, policy, and marketplace ministry.
            </Heading>
          </Reveal>

          <div className="border-t border-[var(--ploy-text-inverse)]/15">
            {SPHERES.map((sphere, i) => (
              <Reveal key={sphere.href} delay={i * 0.05}>
      ...
      {content.sections.map((section, i) => (
        ...
        >
          <Reveal delay={i * 0.05} className="mx-auto max-w-3xl space-y-4">
            <p className="ploy-eyebrow">The through-line</p>
