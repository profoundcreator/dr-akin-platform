  ...
  const platforms = [
    {
      ...
      subtitle: "AALD",
      href: "/work/aald",
      description: "Executive leadership programmes and organisational transformation.",
    },
    {
      title: "Educational Reform",
      subtitle: "Erudio Hub",
      href: "/work/erudio-hub",
      description: "Systemic reform for ministries, universities, and education boards.",
    },
    {
      title: "Execution Think Tank",
      subtitle: "PERFORMX",
      href: "/work/performx",
      description: "Strategy-to-execution frameworks for high-performance teams.",
    },
    {
      title: "Tech Alliances",
      subtitle: "TC Resource Technology",
      href: "/work/tc-resource-technology",
      description: "Technology partnerships for institutional scale.",
    },
  ];
      ...
      <section className="ploy-section">
        <div className="ploy-container space-y-16">
          <Reveal className="max-w-3xl space-y-4">
            <p className="ploy-kicker">Work</p>
            <Heading as="h1" size="section" className="ploy-text-balance">
              Four operating arms building institutions that endure
            </Heading>
            <p className="text-lg leading-relaxed text-[var(--ploy-text-secondary)]">
              Dr. Akin works across corporate transformation, educational reform, execution
              strategy, and technology alliances.
            </p>
          </Reveal>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {platforms.map((platform, i) => (
              <Reveal key={platform.href} delay={i * 0.05}>
                <a
                  href={platform.href}
                  className="group flex h-full flex-col justify-between gap-6 ploy-surface-elevated p-8 transition-all hover:-translate-y-0.5"
                >
                  <div className="space-y-3">
                    <p className="ploy-kicker">{platform.subtitle}</p>
                    <Heading as="h2" size="card">
                      {platform.title}
                    </Heading>
                    <p className="text-sm text-[var(--ploy-text-secondary)]">{platform.description}</p>
                  </div>
